    ...
    <div className="carousel outline outline-1 outline-slate-200 p-3 rounded-md max-w-4xl w-fit my-6 mx-auto">
      <div className="relative overflow-hidden">
        <div className="flex justify-between absolute top left w-full h-full">
          ...
          <button
            onClick={moveNext}
            className="hover:bg-blue-900 text-gray-900 w-10 h-full text-center opacity-75 hover:opacity-100 disabled:opacity-25 disabled:cursor-not-allowed z-10 p-0 m-0 transition-all ease-in-out duration-300"
